import { Clock, Heart, TrendingUp, CheckCircle, Headphones, Calendar } from "lucide-react";
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {benefits.map((benefit, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-6 sm:p-8 hover:shadow-xl transition-all hover:-translate-y-1 border border-blue-100 dark:border-gray-600"
              >
                <div className="bg-blue-600 dark:bg-blue-500 w-12 h-12 rounded-xl flex items-center justify-center mb-4">
