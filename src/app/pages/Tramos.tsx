...
const modulos = [
  {
    ...
    descripcion: "Uso del campus, identidad digital, netiquette, foros y primeras producciones.",
  },
  {
    numero: "2",
    titulo: "Discurso Pedagógico Moderno y Posiciones Críticas",
    descripcion: "De la Escuela Nueva a las pedagogías críticas, decoloniales y de los Derechos Humanos.",
  },
  {
    numero: "3",
    titulo: "Pensamiento Político y Legislación del Sistema Educativo Argentino",
    descripcion: "Historia y marco legal del sistema educativo nacional y provincial.",
  },
  {
    numero: "4",
    titulo: "Diseño de Enseñanza con Tecnología",
    descripcion: "Trabajo colaborativo, TIC en el aula, ciudadanía digital y producción de contenidos educativos.",
  },
  {
    numero: "5",
    titulo: "Didáctica de la Educación Media y Superior",
    descripcion: "Enseñanza, currículum, evaluación y reflexión de las prácticas docentes.",
  },
  {
    numero: "6",
    titulo: "Dimensiones del Sujeto de la Educación",
    descripcion: "Psicología, neurociencias, educabilidad, adolescencia, adultez y perspectiva de Derechos.",
  },
  {
    numero: "7",
    titulo: "Sociologías y Filosofías de la Educación – Escuela y Diversidad",
    descripcion: "Educación y sociedad, enfoques críticos, diversidad cultural y enseñanza en contextos heterogéneos.",
  },
  {
    numero: "8",
    titulo: "Planeamiento y Evaluación de los Aprendizajes",
    descripcion: "Programación, metodologías, evaluación formativa, justicia curricular y TIC.",
  },
  {
    numero: "9",
    titulo: "Observación y Práctica Docente en Nivel Medio y Superior",
    descripcion: "Práctica reflexiva, microclases, evaluación y planificación de proyectos docentes.",
  },
];
...
const tramos = [
  {
    ...
    subtitle: "Para profesionales universitarios, Técnicos Superiores y de Nivel Medio",
    duration: "15 meses (58 semanas)",
    modalidad: "100% a distancia",
    certificacion: "Título oficial: Tramo de Formación Pedagógica para Profesionales Universitarios, Técnicos Superiores y de Nivel Medio",
    ...
    modulos,
    whatsappMsg: "Hola! Quiero más información sobre el Tramo de Formación Pedagógica de Nexoeducativo.",
  },
];

const CurriculumAccordion = ({ modulos }: { modulos: typeof tramos[0]["modulos"] }) => {
      ...
      {modulos.map((mod, i) => (
        ...
        >
          ...
          >
            ...
            <span className={`flex-1 font-medium text-sm sm:text-base ${COLORS.text.heading}`}>
              {mod.titulo}
            </span>
            <ChevronDown
          ...
          {open === i && (
            <div className="px-5 pb-4 pt-2 bg-teal-50/50 dark:bg-teal-900/10 border-t border-teal-100 dark:border-teal-800">
              <p className={`text-sm ${COLORS.text.body} leading-relaxed`}>{mod.descripcion}</p>
            </div>
          )}
        </div>
      ))}
      ...
      <section className="relative overflow-hidden py-16 sm:py-20 bg-gradient-to-br from-teal-600 to-emerald-700 dark:from-teal-900 dark:to-emerald-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-teal-100 max-w-3xl mx-auto mb-10">
            Formación pedagógica para profesionales universitarios y técnicos superiores que desean ejercer la docencia y obtener su habilitación oficial.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {tramos.map((tramo) => (
            <div key={tramo.id} className="space-y-10">
              {/* Main card */}
              <div className={`${COLORS.card.default} rounded-2xl shadow-lg overflow-hidden`}>
                <div className="grid lg:grid-cols-5">
                  ...
                  <div className="lg:col-span-2 relative h-60 lg:h-auto">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 lg:right-auto">
                      <div className="flex items-start gap-2 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-xl p-3">
                        ...
                        <div>
                          <p className="text-xs font-semibold text-gray-900 dark:text-white">Título oficial</p>
                  ...
                  <div className="lg:col-span-3 p-6 sm:p-8 lg:p-10">
                    ...
                    <h2 className={`text-xl sm:text-2xl font-bold ${COLORS.text.heading} mb-1`}>
                      {tramo.title}
                    </h2>
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          {tramo.modalidadDetalle.slice(0, 3).map((m, i) => (
                            <li key={i} className={`text-sm ${COLORS.text.body} leading-snug`}>
                              · {m}
                            </li>
                          ))}
                        </ul>
              ...
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className={`text-xl font-bold ${COLORS.text.heading}`}>Estructura Curricular</h3>
                    <p className={`text-sm ${COLORS.text.body}`}>9 módulos que integran teoría, práctica y reflexión</p>
                  </div>
                </div>
                ...
                <div className={`mt-6 p-4 rounded-xl ${COLORS.card.benefit}`}>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className={`font-semibold ${COLORS.text.heading} text-sm`}>Metodología de Evaluación</p>
                      <p className={`text-sm ${COLORS.text.body} mt-1`}>{tramo.evaluacion}</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-gradient-to-br from-teal-600 to-emerald-700 dark:from-teal-900 dark:to-emerald-900">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-teal-100 mb-8 text-lg">
            15 meses · 100% a distancia · Título oficial · Inscripción permanente
          </p>
          <a
            href={whatsappLink("Hola! Quiero información sobre el Tramo de Formación Pedagógica de Nexoeducativo.")}
            target="_blank"
            rel="noopener noreferrer"
