...
const actualizaciones = [
  {
    ...
    color: "indigo",
    image:
      "https://images.unsplash.com/photo-1719667947229-594a8fdddade?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbW90aW9uYWwlMjB3ZWxsYmVpbmclMjBzY2hvb2wlMjBjaGlsZHJlbnxlbnwxfHx8fDE3NzcwNzU0NTF8MA&ixlib=rb-4.1.0&q=80&w=1080",
    description:
    ...
    destinatarios:
      "Docentes de todos los niveles, equipos de orientación, directivos, tutores y profesionales vinculados al acompañamiento de trayectorias escolares.",
    whatsappMsg:
      "Hola! Quiero más información sobre la Actualización en Salud Mental en Contextos Escolares.",
  ...
  },
  {
    ...
    tagline:
      "Conocimientos de neurociencia aplicados al aprendizaje y la enseñanza",
    duration: "6 meses – 220 horas reloj",
    modalidad: "100% virtual",
    inscripcion: "Permanente",
    color: "violet",
    image:
      "https://images.unsplash.com/photo-1770236711002-e01fbf6f9964?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxuZXVyb3NjaWVuY2UlMjBicmFpbiUyMGxlYXJuaW5nfGVufDF8fHx8MTc3NzA3NTQ0OXww&ixlib=rb-4.1.0&q=80&w=1080",
    description:
    ...
    destinatarios:
      "Docentes de todos los niveles y modalidades, directivos, equipos de orientación, tutores y profesionales vinculados al acompañamiento de trayectorias escolares.",
    whatsappMsg:
      "Hola! Quiero más información sobre la Actualización en Neurología Aplicada a la Educación.",
    badge: "Puntaje Docente",
  },
  {
    id: 3,
    ...
    destinatarios:
      "Docentes de todos los niveles educativos interesados en fortalecer sus competencias emocionales, relacionales y éticas para una educación integral.",
    whatsappMsg:
      "Hola! Quiero más información sobre la Actualización en Educación Emocional y Habilidades Socioafectivas.",
    badge: "Puntaje Docente",
  },
];
    ...
    <main className="min-h-screen">
      ...
      <section className="relative overflow-hidden py-16 sm:py-20 bg-gradient-to-br from-indigo-600 to-purple-700 dark:from-indigo-900 dark:to-purple-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-indigo-100 max-w-3xl mx-auto mb-10">
            Cursos de actualización profesional para docentes que quieren
            mantenerse al día con las últimas tendencias, herramientas y
      ...
      <section className={`py-16 sm:py-20 ${COLORS.section.secondary}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2
              className={`text-2xl sm:text-3xl font-bold ${COLORS.text.heading} mb-4`}
            >
              Cursos Disponibles
            </h2>
            <p className={`${COLORS.text.body} max-w-2xl mx-auto`}>
              Elegí la temática que más se adapte a tus necesidades e intereses
              profesionales. Todos los cursos cuentan con inscripción
              permanente.
            </p>
          </div>
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      <span
                        className={`inline-flex items-center gap-1 text-xs font-medium px-2.5 py-1 rounded-full ${colors.bg} ${colors.text}`}
                      >
                        <Clock className="w-3 h-3" />
                        {curso.duration}
                      </span>
                      <span
                        className={`inline-flex items-center gap-1 text-xs font-medium px-2.5 py-1 rounded-full bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400`}
                      >
                    ...
                    <h3
                      className={`font-bold ${COLORS.text.heading} mb-2 leading-snug`}
                    >
                      {curso.title}
                    </h3>
                    ...
                    <div className="mb-5">
                      <h4
                        className={`text-xs font-semibold uppercase tracking-wide ${colors.text} mb-3 flex items-center gap-1.5`}
                      >
                      ...
                      <ul className="space-y-1.5">
                        {curso.aprendizajes.slice(0, 4).map((item, i) => (
                          <li
                            key={i}
                            className={`flex items-start gap-2 text-xs ${COLORS.text.body}`}
                          >
                            <CheckCircle
                              className={`w-3.5 h-3.5 ${colors.text} shrink-0 mt-0.5`}
                            />
                            {item}
                          </li>
                        ))}
                    ...
                    <div className={`p-3 rounded-lg ${colors.bg} mb-5`}>
                      <div
                        className={`flex items-start gap-2 text-xs ${colors.text}`}
                      >
      ...
      <section className="py-16 bg-gradient-to-br from-indigo-600 to-purple-700 dark:from-indigo-900 dark:to-purple-900">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <a
            href={whatsappLink(
              "Hola! Quiero información sobre las Actualizaciones Académicas de Nexoeducativo.",
            )}
            target="_blank"
            rel="noopener noreferrer"
